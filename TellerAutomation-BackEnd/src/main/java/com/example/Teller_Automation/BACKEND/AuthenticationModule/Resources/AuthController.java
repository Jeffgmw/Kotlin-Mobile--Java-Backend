package com.example.Teller_Automation.BACKEND.AuthenticationModule.Resources;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.MailService.MailService;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.MailService.MailsService;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.OTP.OTP;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.OTP.OTPRepository;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.OTP.OTPService;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Requests.*;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Responses.JwtResponse;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Responses.MessageResponse;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Roles.ERole;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Roles.Role;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Roles.RoleRepository;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Security.Jwt.JwtUtils;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Security.Services.UserDetailsImpl;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Users.UserStatusDTO;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Users.Users;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Users.UsersRepository;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.Users.UsersService;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.utils.PasswordGeneratorUtil;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.utils.Shared.EntityResponse;
import com.example.Teller_Automation.BACKEND.AuthenticationModule.utils.Shared.UserRequestContext;
...
public EntityResponse delete(@RequestParam Long sn) {return usersService.delete(sn);}
    ...
    public ResponseEntity<?> userSignIn(@Valid @RequestBody LoginRequest loginRequest, HttpServletResponse res) throws MessagingException {
        ...
        try {
            ...
            response.setMessage("Hi, " + loginRequest.getUsername() + ", welcome to Teller Automation");
            response.setStatusCode(HttpStatus.CREATED.value());
            response.setEntity(jwtResponse);
