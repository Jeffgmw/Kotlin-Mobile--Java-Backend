...
public class TellerService {
    ...
    public EntityResponse findByPfNumber(Long pfNumber) {
        EntityResponse res = new EntityResponse<>();
        try {
...
//            if (teller.isPresent()) {
//                Teller t = teller.get();
//                entityResponse.setMessage("Teller found");
//                entityResponse.setStatusCode(HttpStatus.FOUND.value());
...
//        }
//    catch (Exception e){
//        entityResponse.setMessage("Error was encountered");
//        entityResponse.setStatusCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
//        entityResponse.setEntity(null);
//    }
//    return entityResponse;}}
